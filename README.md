...
<body>
    <div class="container">
        <h1 style="bold">🏆 Unialgo</h1>
        <h2>📢 News</h2>
        <i>We are applying some <b>major changes</b>, so we won't be accepting the PR's till 17 October 2024. The project is not offline</i>
        <h2>🌐 Overview</h2>
        <p>UniAlgo is a platform designed to help users understand competitive programming (CP). It features a curated collection of unique CP concepts, algorithms, and articles that take time and effort to master.</p>
        <h2>🌟 Key Features:</h2>
        <ul>
